				...
				<div class="row"> 
					<div class="col-lg-10">
						<div class="form-group">
				    		...
				    		<div class="col-lg-5"> 
					    		{!! Form::text('master',isset($model) ? null : 'SUBOPT', ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
						<div class="form-group">
				    		<label class="control-label col-lg-2">Output</label>
				    		<div class="col-lg-8"> 
					    		{!! Form::select('output_id',['' => 'Pilih Output'] + $output, null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
						<div class="form-group">
				    		<label class="control-label col-lg-2">Nama Suboutput*</label>
				    		<div class="col-lg-8"> 
					    		{!! Form::text('nama_suboutput',null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
			  		</div>
		  		</div>
