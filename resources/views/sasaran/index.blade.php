...
$(function() {
   $('#datatable').DataTable({
      ...
      "columns": [
         ...
         { "title": "Nama Sasaran", "data": "nama_sasaran" },
         ...
         { "title" : "", "orderable": false, "width": "170px", "className": "text-center", render: function (data, type, row, meta) {
            ...
            var dele = '';
            @can('sasaran_view')
               view = '<a href="{{ Navigation::adminUrl('/sasaran') }}/'+row.id+'/view" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Lihat"><i class="icon-eye"></i></a>';
            @endcan
            @can('sasaran_edit')
               edit = '<a href="{{ Navigation::adminUrl('/sasaran') }}/'+row.id+'/edit" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="Ubah"><i class="icon-pencil"></i></a>';
            @endcan
            @can('sasaran_delete')
               dele = '<button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Hapus" onclick="deleteRow(\'{{ Navigation::adminUrl('/sasaran') }}/'+row.id+'/delete\',\'{{ Navigation::adminUrl('/sasaran') }}\');"><i class="icon-eraser3"></i></button>';
            @endcan
      ...
      <div class="content-wrapper">
         <div class="panel panel-flat">
            ...
            <div class="panel-body">
               ...
               @can('sasaran_create')
                  <a href="{{ Navigation::adminUrl('/sasaran') }}/create" class="btn btn-primary btn-xs">
