@extends('layouts.app')
@section('title', 'Faq Rehab Bg Pusaka Istana')
@section('content')
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Rehab Pusaka Istana Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('rehab_pusaka_istana_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
