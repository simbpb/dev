@extends('layouts.app')
@section('title', 'Faq Bg Mitigasi Bencana')
@section('content')
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Mitigasi Bencana Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('mitigasi_bencana_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
