@extends('layouts.app')
@section('title', 'Faq Kws Pusaka Pemukiman Trad')
@section('content')
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Kws Pusaka Trad Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('kws_pusaka_trad_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
