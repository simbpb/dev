@extends('layouts.app')
@section('title', 'Faq Kws Prioritas Nasional')
@section('content')
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Kws Prioritas Nasional Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('kws_prioritas_nasional_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
