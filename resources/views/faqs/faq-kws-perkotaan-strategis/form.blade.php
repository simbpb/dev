@extends('layouts.app')
@section('title', 'Faq Kws Perkotaan Strategis')
@section('content')
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Kws Perkotaan Strategis Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('kws_perkotaan_strategis_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
