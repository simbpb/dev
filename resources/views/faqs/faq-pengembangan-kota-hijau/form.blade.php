@extends('layouts.app')
@section('title', 'Faq Pengembangan Kota Hijau')
@section('content')
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Pengembangan Kota Hijau Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('pengembangan_kota_hijau_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
