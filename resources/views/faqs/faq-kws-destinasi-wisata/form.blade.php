@extends('layouts.app')
@section('title', 'Faq Kws Destinasi Wisata')
@section('content')
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Kws Destinasi Wisata Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('kws_destinasi_wisata_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9"> 
                                {!! Form::text('lokasi_berada_di_kawasan',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
