				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Cagar Budaya Id</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('cagar_budaya_id',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Nama Aset Cagar Budaya</label>
                            <div class="col-lg-9"> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Nama Instansi Cagar Budaya</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('nama_instansi_cagar_budaya',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Lokasi Cagar Budaya</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('lokasi_cagar_budaya',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">File Sk Penetapan Cagar Budaya</label>
                            <div class="col-lg-9"> 
                                {!! Form::file('file_sk_penetapan_cagar_budaya',null, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        @if (!empty($model['file_sk_penetapan_cagar_budaya']))
                        <div class="form-group">
                            <label class="control-label col-lg-3">Attach File</label>
                            <div class="col-lg-9">
                                {!! ($model['file_sk_penetapan_cagar_budaya']) ? $model['file_sk_penetapan_cagar_budaya'] : null !!}
                            </div>
                        </div>
                        @endif 
