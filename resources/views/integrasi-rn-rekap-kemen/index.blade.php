   ...
   $('#datatable').DataTable({
      ...
      "columns": [
         ...
         { "title" : "No.", "data": null, "orderable": false, "width": "40px", render: function (data, type, row, meta) {
			...
			{ "title": "Kemen Sewa", "data": "kemen_sewa" },
			{ "title": "Kemen Sewa Beli", "data": "kemen_sewa_beli" },
			{ "title": "Kemen Lunas", "data": "kemen_lunas" },
			{ "title": "Kemen Hak Milik", "data": "kemen_hak_milik" },
