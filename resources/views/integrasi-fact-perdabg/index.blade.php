...
$(function() {
   $('#datatable').DataTable({
      ...
      "columns": [
         ...
         { "title": "Id Perda Bg", "data": "id_perda_bg" },
			...
			{ "title": "Status Perdabg", "data": "status_perdabg" },
			{ "title": "Keterangan", "data": "keterangan" },
			{ "title": "Tgl Input Perdabg", "data": "tgl_input_perdabg" },
			{ "title": "Tahun Perdabg", "data": "tahun_perdabg" },
			{ "title": "No Perdabg", "data": "no_perdabg" },
			...
			{ "title": "Perdabg Sk", "data": "perdabg_sk" },
