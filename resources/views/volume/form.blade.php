				...
				<div class="row"> 
					<div class="col-lg-10">
						<div class="form-group">
				    		...
				    		<div class="col-lg-5"> 
					    		{!! Form::text('master',isset($model) ? null : 'VOL', ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
						<div class="form-group">
						...
						<div class="form-group">
				    		<label class="control-label col-lg-2">Jenis Volume*</label>
				    		<div class="col-lg-8"> 
					    		{!! Form::text('jenis_volume',null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
			  		</div>
		  		</div>
