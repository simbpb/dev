            ...
            <div class="panel-body">
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Id Rekap Prop</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('id_rekap_prop',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Prop Sewa</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('prop_sewa',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Prop Sewa Beli</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('prop_sewa_beli',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Prop Lunas</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('prop_lunas',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Prop Hak Milik</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('prop_hak_milik',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
