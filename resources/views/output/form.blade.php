				...
				<div class="row"> 
					<div class="col-lg-6">
						<div class="form-group">
				    		...
				    		<div class="col-lg-5"> 
					    		{!! Form::text('master',isset($model) ? null : 'OPT', ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
						<div class="form-group">
				    		<label class="control-label col-lg-2">Nama Output*</label>
				    		<div class="col-lg-10"> 
					    		{!! Form::text('nama_output',null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
			  		</div>
		  		</div>
