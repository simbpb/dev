...
<div class="row">
   <div class="col-xs-12">
      <a href="/si-bpb/user-hsbgn/create" class="btn btn-success btn-sm">
...
<script>
   var myTable = $('#data-table').DataTable({
      ...
      "ajax": function(data, callback, settings) {
         ...
         $.getJSON(base_url + '/si-bpb/user-hsbgn', {
            limit: data.length,
      ...
      "columns": [
         ...
         { "title" : "Action", "orderable": false, "width": "100px", "className": "text-center", render: function (data, type, row, meta) {
            var edt = '<a href="'+base_url+'/si-bpb/user-hsbgn/'+row.id+'/edit"><i class="ace-icon fa fa-pencil"></i></a>';
            var del = '<a href="'+base_url+'/si-bpb/user-hsbgn/'+row.id+'/delete"><i class="ace-icon fa fa-trash"></i></a>';
            return edt+' '+del;
         }},
