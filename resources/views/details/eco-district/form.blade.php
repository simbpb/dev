				...
				<div class="row"> 
					<div class="col-lg-6">
						<div class="form-group">
				  		...
				  		<div class="form-group">
				    		<label class="control-label col-lg-3">Value Eco District*</label>
				    		<div class="col-lg-9"> 
					    		{!! Form::text('value_eco_district',null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
				  		<div class="form-group">
				    		<label class="control-label col-lg-3">Tipe Dokumen*</label>
				    		<div class="col-lg-9"> 
					    		{!! Form::text('tipe_dok_eco_district',null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
			  		</div>
			  		<div class="col-lg-6">
