					...
					<div class="col-xs-6">
						<div class="form-group">
				  		...
				  		<div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Luas Kws</label>
                                <div class="form-group"><b>{!! $model['luas_kws'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Satuan Luas Kws</label>
                            ...
                            <div class="form-group">
                                <label>Uraian Singkat Karakter Lokasi</label>
                                <div class="form-group"><b>{!! $model['uraian_singkat_karakter_lokasi'] !!}</b></div>
                            </div>
