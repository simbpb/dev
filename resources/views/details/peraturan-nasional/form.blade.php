@extends('layouts.app')
@section('title', 'Peraturan Nasional')
            ...
            <div class="panel-body">
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">No Peraturan Nasional*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('no_peraturan_nasional',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Tentang*</label>
                            <div class="col-lg-9"> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Tempat Ditetapkan*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('tempat_ditetapkan',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Tgl Ditetapkan*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('tgl_ditetapkan',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Bln Ditetapkan*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('bln_ditetapkan',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Thn Ditetapkan*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('thn_ditetapkan',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
