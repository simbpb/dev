            ...
            <div class="panel-body">
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Nama Permohonan Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('nama_permohonan_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Nama Pemilik Perorangan Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('nama_pemilik_perorangan_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Id Pemilik Perorangan Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('id_pemilik_perorangan_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Jenis Id Pemilik Perorangan Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('jenis_id_pemilik_perorangan_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Nama Pemilik Badan Usaha Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('nama_pemilik_badan_usaha_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">No Akta Pendirian Badan Usaha Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('no_akta_pendirian_badan_usaha_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Nama Institusi Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('nama_institusi_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">No Ikmn Pemerintah Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('no_ikmn_pemerintah_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">No Hdno Pemerintah Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('no_hdno_pemerintah_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Propinsi Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('propinsi_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Kabkota Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('kabkota_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Kec Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('kec_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Kel Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('kel_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Rt Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('rt_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Rw Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('rw_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Alamat Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('alamat_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Telp Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('telp_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Email Pemilik Bg Slf Ke1*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('email_pemilik_bg_slf_ke1',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Perpanjangan Slf Ke*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('perpanjangan_slf_ke',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
