            ...
            <div class="panel-body">
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Realisasi Keu*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('realisasi_keu',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Realisasi Fisik*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('realisasi_fisik',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
