				...
				<div class="row"> 
					<div class="col-lg-6">
						<div class="form-group">
				  		...
				  		<div class="form-group">
				    		<label class="control-label col-lg-3">Pariwisata KSPN*</label>
				    		<div class="col-lg-9"> 
					    		{!! Form::text('pariwisata_kspn',null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
				  		<div class="form-group">
				    		<label class="control-label col-lg-3">Tipe Dokumen*</label>
				    		<div class="col-lg-9"> 
					    		{!! Form::text('tipe_dok_kspn',null, ['class' => 'form-control']) !!}
					    	</div>
				  		</div>
			  		</div>
			  		<div class="col-lg-6">
