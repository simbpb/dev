            ...
            <div class="panel-body">
				...
				<div class="row"> 
					<div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Luas Wilayah Kab Kota*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('luas_wilayah_kab_kota',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Satuan Luas Wilayah Kab Kota*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('satuan_luas_wilayah_kab_kota',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-3">Bentuk Rth Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('bentuk_rth_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Nama Kawasan Rth Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('nama_kawasan_rth_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Lokasi Kawasan Rth Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('lokasi_kawasan_rth_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Titik Koordinat Lat Rth Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('titik_koordinat_lat_rth_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Titik Koordinat Long Rth Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('titik_koordinat_long_rth_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Luas Kawasan Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('luas_kawasan_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Satuan Luas Kawasan Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('satuan_luas_kawasan_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 

                        <div class="form-group">
                            <label class="control-label col-lg-3">Status Aset Private*</label>
                            <div class="col-lg-9"> 
                                {!! Form::text('status_aset_private',null, ['class' => 'form-control']) !!}
                            </div>
                        </div> 
