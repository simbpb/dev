					...
					<div class="col-xs-6">
						<div class="form-group">
				  		...
				  		<div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Nama Permohonan Imb</label>
                                <div class="form-group"><b>{!! $model['nama_permohonan_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Nama Pemilik Perorangan Bg Imb</label>
                                <div class="form-group"><b>{!! $model['nama_pemilik_perorangan_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Pemilik Perorangan Bg Imb Id</label>
                                <div class="form-group"><b>{!! $model['pemilik_perorangan_bg_imb_id'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Nama Pemilik Badan Usaha Bg Imb</label>
                                <div class="form-group"><b>{!! $model['nama_pemilik_badan_usaha_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>No Akta Pendirian Badan Usaha Bg Imb</label>
                                <div class="form-group"><b>{!! $model['no_akta_pendirian_badan_usaha_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Nama Institusi Imb</label>
                                <div class="form-group"><b>{!! $model['nama_institusi_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>No Ikmn Pemerintah Imb</label>
                                <div class="form-group"><b>{!! $model['no_ikmn_pemerintah_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>No Hdno Pemerintah Imb</label>
                                <div class="form-group"><b>{!! $model['no_hdno_pemerintah_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Propinsi Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['propinsi_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Kabkota Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['kabkota_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Kec Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['kec_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Kel Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['kel_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Rt Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['rt_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Rw Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['rw_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Alamat Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['alamat_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Telp Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['telp_pemilik_bg_imb'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Email Pemilik Bg Imb</label>
                                <div class="form-group"><b>{!! $model['email_pemilik_bg_imb'] !!}</b></div>
                            </div>
