						...
						<div class="form-group">
				  		...
				  		<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group"><b>{!! $model['nama_kelurahan'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Rt</label>
                                <div class="form-group"><b>{!! $model['rt'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>Rw</label>
                                <div class="form-group"><b>{!! $model['rw'] !!}</b></div>
                            </div>

                            <div class="form-group">
                                <label>No Rumah</label>
                                <div class="form-group"><b>{!! $model['no_rumah'] !!}</b></div>
                            </div>
