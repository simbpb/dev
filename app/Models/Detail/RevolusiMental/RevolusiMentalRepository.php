...
class RevolusiMentalRepository
{

    protected $model;
    protected $kodifikasi;
    protected $basePath1 = '/files/details/revolusi-mental/dokumentasi';

      
    public function __construct(
        RevolusiMental $model
    ) {
        $this->model = $model;
    ...
    public function list($request)
    {
        ...
        $model = $this->model->select(
                        'tbl_detail_revolusi_mental.id',
                        'tbl_detail_revolusi_mental.thn_periode_keg',
                        'tbl_detail_revolusi_mental.nama_propinsi',
                        'tbl_detail_revolusi_mental.nama_kabupatenkota',
                        'tbl_detail_revolusi_mental.nama_kegiatan',
						'tbl_detail_revolusi_mental.thn_anggaran',
						'tbl_detail_revolusi_mental.sumber_anggaran',
						'tbl_detail_revolusi_mental.alokasi_anggaran',
						'tbl_detail_revolusi_mental.volume_pekerjaan',
						'tbl_detail_revolusi_mental.instansi_unit_organisasi_pelaksana',
						'tbl_detail_revolusi_mental.lokasi_kegiatan_proyek',
						'tbl_detail_revolusi_mental.titik_koordinat_lat',
						'tbl_detail_revolusi_mental.titik_koordinat_long',
						'tbl_detail_revolusi_mental.status_aset',
						'tbl_detail_revolusi_mental.biaya_pelaksanaan_kontraktor',
						'tbl_detail_revolusi_mental.manajemen_konstruksi',
						'tbl_detail_revolusi_mental.rencana_keu',
						'tbl_detail_revolusi_mental.rencana_fisik',
						'tbl_detail_revolusi_mental.dokumentasi',
                        'tbl_detail_revolusi_mental.is_actived'
                    )->searchOrder($request, [
                        'tbl_detail_revolusi_mental.thn_periode_keg',
                        'tbl_detail_revolusi_mental.nama_propinsi',
                        'tbl_detail_revolusi_mental.nama_kabupatenkota',
        ...
        return (new RevolusiMentalTransformer)->transformPaginate($model);
    }

    public function find($id)
    {
        $model = $this->model->find($id);
        return (new RevolusiMentalTransformer)->transformDetail($model);
    }
