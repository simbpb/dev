...
class KwsPusakaPemukimanTradRepository
{

    protected $model;
    protected $program;
    protected $basePath1 = '/files/details/kws-pusaka-pemukiman-trad/dokumentasi';

      
    public function __construct(
        KwsPusakaPemukimanTrad $model,
    ...
    public function list($request)
    {
        ...
        $model = $this->model->select(
                        'tbl_detail_kws_pusaka_pemukiman_trad.id',
                        'tbl_detail_kws_pusaka_pemukiman_trad.thn_periode_keg',
                        'tbl_detail_kws_pusaka_pemukiman_trad.lokasi_kode',
                        'tbl_detail_kws_pusaka_pemukiman_trad.nama_propinsi',
                        'tbl_detail_kws_pusaka_pemukiman_trad.nama_kabupatenkota',
                        'tbl_detail_kws_pusaka_pemukiman_trad.nama_kawasan',
						'tbl_detail_kws_pusaka_pemukiman_trad.jenis_kawasan',
						'tbl_detail_kws_pusaka_pemukiman_trad.nama_kegiatan',
						'tbl_detail_kws_pusaka_pemukiman_trad.thn_anggaran',
						'tbl_detail_kws_pusaka_pemukiman_trad.sumber_anggaran',
						'tbl_detail_kws_pusaka_pemukiman_trad.alokasi_anggaran',
						'tbl_detail_kws_pusaka_pemukiman_trad.volume_pekerjaan',
						'tbl_detail_kws_pusaka_pemukiman_trad.instansi_unit_organisasi_pelaksana',
						'tbl_detail_kws_pusaka_pemukiman_trad.lokasi_kegiatan_proyek',
						'tbl_detail_kws_pusaka_pemukiman_trad.titik_koordinat_lat',
						'tbl_detail_kws_pusaka_pemukiman_trad.titik_koordinat_long',
						'tbl_detail_kws_pusaka_pemukiman_trad.status_aset',
						'tbl_detail_kws_pusaka_pemukiman_trad.biaya_pelaksanaan_kontraktor',
						'tbl_detail_kws_pusaka_pemukiman_trad.manajemen_konstruksi',
						'tbl_detail_kws_pusaka_pemukiman_trad.rencana_keu',
						'tbl_detail_kws_pusaka_pemukiman_trad.rencana_fisik',
						'tbl_detail_kws_pusaka_pemukiman_trad.dokumentasi',
                        'tbl_detail_kws_pusaka_pemukiman_trad.is_actived'
                    )->searchOrder($request, [
                        'tbl_detail_kws_pusaka_pemukiman_trad.thn_periode_keg',
                        'tbl_detail_kws_pusaka_pemukiman_trad.lokasi_kode',
                        'tbl_detail_kws_pusaka_pemukiman_trad.nama_propinsi',
        ...
        return (new KwsPusakaPemukimanTradTransformer)->transformPaginate($model);
    }

    public function find($id)
    {
        $model = $this->model->find($id);
        return (new KwsPusakaPemukimanTradTransformer)->transformDetail($model);
    }
