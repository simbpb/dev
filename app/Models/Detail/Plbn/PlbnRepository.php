...
class PlbnRepository
{
    ...
    public function list($request)
    {
        ...
        $model = $this->model->select(
						...
						'tbl_detail_plbn.thn_anggaran',
						'tbl_detail_plbn.sumber_anggaran',
						'tbl_detail_plbn.alokasi_anggaran',
						...
						'tbl_detail_plbn.rencana_keu',
						'tbl_detail_plbn.rencana_fisik',
						'tbl_detail_plbn.dokumentasi',
