...
use App\Models\IntegrasiRnRekapProp\IntegrasiRnRekapPropRepository;

class IntegrasiRnRekapPropController extends Controller {
    ...
    public function __construct(
        IntegrasiRnRekapPropRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'integrasi-rn-rekap-prop';
    }
