...
use App\Models\IntegrasiRnRekapKemen\IntegrasiRnRekapKemenRepository;

class IntegrasiRnRekapKemenController extends Controller {
    ...
    public function __construct(
        IntegrasiRnRekapKemenRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'integrasi-rn-rekap-kemen';
    }
    ...
    public function create(Request $request)
    {
        ...
        return view($this->view.'.form', compact('path','provinces','validator'));
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view($this->view.'.form', compact('path','model','provinces','validator'));
    }
    ...
    public function view($id)
    {
        $model = $this->model->find($id);
        $path = $this->view;
        return view($this->view.'.view', compact('path','model'));
    }
