...
use App\Models\IntegrasiFactPerdabg\IntegrasiFactPerdabgRepository;

class IntegrasiFactPerdabgController extends Controller {
    ...
    public function __construct(
        IntegrasiFactPerdabgRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'integrasi-fact-perdabg';
    }
    ...
    public function create(Request $request)
    {
        ...
        return view($this->view.'.form', compact('path','validator','provinces'));
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view($this->view.'.form', compact('path','model','validator','provinces'));
    }
