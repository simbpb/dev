...
use App\Models\Detail\PengembanganKotaHijau\PengembanganKotaHijauRepository;

class PengembanganKotaHijauController extends Controller {
    ...
    public function __construct(
        PengembanganKotaHijauRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'pengembangan-kota-hijau';
    }
...
$rule['attribute_kota_hijau'] = 'required';
...
$rule['uraian_singkat_karakter_lokasi'] = 'required';
