...
use App\Models\Detail\RehabBgPusakaIstana\RehabBgPusakaIstanaRepository;

class RehabBgPusakaIstanaController extends Controller {
    ...
    public function __construct(
        RehabBgPusakaIstanaRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'rehab-bg-pusaka-istana';
    }
