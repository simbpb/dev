...
use App\Models\Detail\Rtbl\RtblRepository;

class RtblController extends Controller {
    ...
    protected function validationRules() {
        ...
        $rule['tahun_rtbl'] = 'required';
        $rule['usulan_kws_rtbl'] = 'required';
        $rule['luas_kws'] = 'required';
        $rule['satuan_luas_kws'] = 'required';
        $rule['cakupan_wilayah'] = 'required';
        $rule['uraian_usulan_kws'] = 'required';
