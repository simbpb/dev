...
use App\Models\Detail\BgSlfke1\BgSlfke1Repository;

class BgSlfke1Controller extends Controller {
    ...
    public function __construct(
        BgSlfke1Repository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'bg-slfke-1';
    }
...
$rule['nama_permohonan_slf_ke1'] = 'required';
$rule['nama_pemilik_perorangan_bg_slf_ke1'] = 'required';
$rule['id_pemilik_perorangan_bg_slf_ke1'] = 'required';
$rule['jenis_id_pemilik_perorangan_bg_slf_ke1'] = 'required';
$rule['nama_pemilik_badan_usaha_bg_slf_ke1'] = 'required';
$rule['no_akta_pendirian_badan_usaha_bg_slf_ke1'] = 'required';
$rule['nama_institusi_slf_ke1'] = 'required';
$rule['no_ikmn_pemerintah_slf_ke1'] = 'required';
$rule['no_hdno_pemerintah_slf_ke1'] = 'required';
$rule['propinsi_pemilik_bg_slf_ke1'] = 'required';
$rule['kabkota_pemilik_bg_slf_ke1'] = 'required';
$rule['kec_pemilik_bg_slf_ke1'] = 'required';
$rule['kel_pemilik_bg_slf_ke1'] = 'required';
$rule['rt_pemilik_bg_slf_ke1'] = 'required';
$rule['rw_pemilik_bg_slf_ke1'] = 'required';
$rule['alamat_pemilik_bg_slf_ke1'] = 'required';
$rule['telp_pemilik_bg_slf_ke1'] = 'required';
$rule['email_pemilik_bg_slf_ke1'] = 'required';
...
$rule['perpanjangan_slf_ke'] = 'required';
