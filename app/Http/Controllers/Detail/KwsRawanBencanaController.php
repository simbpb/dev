...
use App\Models\Detail\KwsRawanBencana\KwsRawanBencanaRepository;

class KwsRawanBencanaController extends Controller {
    ...
    public function __construct(
        KwsRawanBencanaRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'kws-rawan-bencana';
    }
