...
use App\Models\Detail\Plbn\PlbnRepository;

class PlbnController extends Controller {
...
$rule['realisasi_keu'] = 'required';
$rule['realisasi_fisik'] = 'required';
$rule['permasalahan'] = 'required';
$rule['tindak_lanjut'] = 'required';
