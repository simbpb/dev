...
use App\Models\Detail\PengelolaTeknisBersertifikasi\PengelolaTeknisBersertifikasiRepository;

class PengelolaTeknisBersertifikasiController extends Controller {
    ...
    public function __construct(
        PengelolaTeknisBersertifikasiRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'pengelola-teknis-bersertifikasi';
    }
    ...
    protected function validationRules($scope = 'create') {
        ...
        $rule['No_sertifikat_pengelola_teknis'] = 'required';
$rule['Tgl_sertifikat_pengelola_teknis'] = 'required';
$rule['Nama_Pejabat'] = 'required';
$rule['Jabatan'] = 'required';
$rule['Nama_pengelola_teknis'] = 'required';
$rule['No_KTP_pengelola_teknis'] = 'required';
$rule['Dinas_Instansi_asal_Unit_org'] = 'required';
$rule['Alamat_lengkap_pengelola_teknis'] = 'required';
$rule['Pendidikan_terakhir_pengelola_teknis'] = 'required';
...
$rule['Keterangan'] = 'required';
                        ...
                        if ($scope == 'create') {
                            $rule['file_Sertifikat_pengelola_teknis'] = 'required';
                        }
