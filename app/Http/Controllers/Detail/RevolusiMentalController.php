...
use App\Models\Detail\RevolusiMental\RevolusiMentalRepository;

class RevolusiMentalController extends Controller {
    ...
    public function __construct(
        RevolusiMentalRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'revolusi-mental';
    }
