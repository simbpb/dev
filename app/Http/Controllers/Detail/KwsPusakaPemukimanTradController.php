...
use App\Models\Detail\KwsPusakaPemukimanTrad\KwsPusakaPemukimanTradRepository;

class KwsPusakaPemukimanTradController extends Controller {
    ...
    public function __construct(
        KwsPusakaPemukimanTradRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'kws-pusaka-pemukiman-trad';
    }
