...
use App\Models\Detail\KwsPerkotaanStrategis\KwsPerkotaanStrategisRepository;

class KwsPerkotaanStrategisController extends Controller {
    ...
    public function __construct(
        KwsPerkotaanStrategisRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'kws-perkotaan-strategis';
    }
    ...
    protected function validationRules($scope = 'create') {
        ...
        $rule['nama_kws_perkotaan'] = 'required';
