...
use App\Models\Detail\RgTerbukapublik\RgTerbukapublikRepository;

class RgTerbukapublikController extends Controller {
    ...
    public function __construct(
        RgTerbukapublikRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'rg-terbukapublik';
    }
