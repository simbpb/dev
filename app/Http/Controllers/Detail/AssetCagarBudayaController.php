...
use App\Models\Detail\AssetCagarBudaya\AssetCagarBudayaRepository;

class AssetCagarBudayaController extends Controller {
    ...
    public function __construct(
        AssetCagarBudayaRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'asset-cagar-budaya';
    }
