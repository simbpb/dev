...
use App\Models\Detail\KwsCagarBudaya\KwsCagarBudayaRepository;

class KwsCagarBudayaController extends Controller {
    ...
    public function __construct(
        KwsCagarBudayaRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'kws-cagar-budaya';
    }
    ...
    protected function validationRules($scope = 'create') {
        ...
        $rule['nama_aset_cagar_budaya'] = 'required';
$rule['klasifikasi_cagar_budaya'] = 'required';
$rule['nama_instansi_cagar_budaya'] = 'required';
$rule['lokasi_cagar_budaya'] = 'required';
$rule['sk_penetapan'] = 'required';

                        if ($scope == 'create') {
                            $rule['file_SK_penetapan_cagar_budaya'] = 'required';
                        }
