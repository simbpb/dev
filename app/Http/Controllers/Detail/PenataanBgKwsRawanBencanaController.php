...
use App\Models\Detail\PenataanBgKwsRawanBencana\PenataanBgKwsRawanBencanaRepository;

class PenataanBgKwsRawanBencanaController extends Controller {
    ...
    public function __construct(
        PenataanBgKwsRawanBencanaRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'penataan-bg-kws-rawan-bencana';
    }
