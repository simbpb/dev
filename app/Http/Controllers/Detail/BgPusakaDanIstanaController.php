...
use App\Models\Detail\BgPusakaDanIstana\BgPusakaDanIstanaRepository;

class BgPusakaDanIstanaController extends Controller {
    ...
    public function __construct(
        BgPusakaDanIstanaRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'bg-pusaka-dan-istana';
    }
