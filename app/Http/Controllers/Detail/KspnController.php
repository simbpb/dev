...
use App\Models\Detail\Kspn\KspnRepository;

class KspnController extends Controller {
    ...
    protected function validationRules() {
        ...
        $rule['pariwisata_kspn'] = 'required';
        $rule['tipe_dok_kspn'] = 'required';
