...
use App\Models\Detail\RthRencanaTigapuluhpersen\RthRencanaTigapuluhpersenRepository;

class RthRencanaTigapuluhpersenController extends Controller {
    ...
    public function __construct(
        RthRencanaTigapuluhpersenRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'rth-rencana-tigapuluhpersen';
    }
    ...
    protected function validationRules($scope = 'create') {
        ...
        $rule['dok_rencana_kota_hijau_rakh'] = 'required';

                        if ($scope == 'create') {
                            $rule['file_dok_rencana_kota_hijau_rakh'] = 'required';
                        }
$rule['nama_dokumen_perencanaan'] = 'required';
$rule['dok_disusun_tahun'] = 'required';
$rule['dok_disahkan_oleh'] = 'required';
