...
use App\Models\Detail\KebunRaya\KebunRayaRepository;

class KebunRayaController extends Controller {
    ...
    public function __construct(
        KebunRayaRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'kebun-raya';
    }
