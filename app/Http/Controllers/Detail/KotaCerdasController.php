...
use App\Models\Detail\KotaCerdas\KotaCerdasRepository;

class KotaCerdasController extends Controller {
    ...
    public function __construct(
        KotaCerdasRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'kota-cerdas';
    }
...
$rule['tipe_dok_kota_cerdas'] = 'required';
