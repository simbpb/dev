...
use App\Models\Detail\KwsLingkstrategis\KwsLingkstrategisRepository;

class KwsLingkstrategisController extends Controller {
    ...
    public function __construct(
        KwsLingkstrategisRepository $model,
        LokasiRepository $lokasi
    ) {
        $this->model = $model;
        $this->lokasi = $lokasi;
        $this->view = 'kws-lingkstrategis';
    }
...
$rule['nama_kws_lingkstrategis'] = 'required';
